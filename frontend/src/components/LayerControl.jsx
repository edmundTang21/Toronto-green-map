...
const LAYER_DEFS = [
  ...
  { id: 'parking',      label: 'General Parking Lots', swatchClass: '',       swatchStyle: { background: 'rgba(239,68,68,0.45)' },                      section: 'Parking' },
  { id: 'greenp',       label: 'City-owned Parking Lots', swatchClass: 'circle', swatchStyle: { background: '#16a34a' },                                    section: 'Parking' },
  ...
  { id: 'boundary',     label: 'Study Area - Liberty Village', swatchClass: '',       swatchStyle: { background: 'rgba(59,130,246,0.15)', borderColor: '#3b82f6' }, section: 'Other' },
